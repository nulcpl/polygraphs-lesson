# Introducing PolyGraphs: Running Philosophical Simulations and Analyzing Synthetic Data — Part 1: Running Simulations
...
As already indicated, PolyGraphs is a tool for running computer simulations. If you have no familiarity with this approach to humanities (and/or natural or social scientific) research, we strongly advise reading Schmitz et al.’s lesson on simulating historical communication networks in Python by way of introduction.[^9] Two key conceptual points from that article are worth stressing here.
...
<p align="center"><img src="images/karate.png" alt="A collection of 34 blue dots ('nodes') connected by 78 black lines ('edges')"></p>

*Figure 1. An example of a graph. In PolyGraphs, the nodes represent agents, and the edges lines of communication between them.*
...
From a technical point of view, some familiarity with Python is assumed in what follows. If you do not already have such familiarity, you can begin with an introductory lesson such as Turkel and Crymble’s.[^12] This said, it is anticipated that you may further your knowledge of Python through this lesson – and can deepen your understanding (e.g. of class inheritance, which we will use in part 2) with materials available elsewhere.[^13] Similar remarks apply to a range of further Python libraries. In particular, over the two parts of this lesson, we will import and use: [numpy][3]; [pandas][4]; [matplotlib][5]; [networkx][6]; and [seaborn][7]. 
...
<p align="center"><img src="images/polygraphs_printout.png" alt="Image displaying text and numbers."></p>

*Figure 2. The printout from the PolyGraphs test run.*
...
<p align="center"><img src="images/test_config.png" alt="Text containing lines numbered 1 to 20. Some lines contain comments. Others specify parameter names and their values, separated by a colon."></p>

*Figure 3. The configuration file for the PolyGraphs test run.*
...
In [part 2](part-2-analyzing-data.md), we will turn to the question of how to analyze the synthetic data that PolyGraphs generates, so as to understand how communities form opinions over time.
