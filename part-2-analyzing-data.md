...
You can download the (2GB) dataset for our case study on mis- and disinformation from its Zenodo record: [https://doi.org/10.5281/zenodo.ZENODO-DATASET-DOI](https://doi.org/10.5281/zenodo.ZENODO-DATASET-DOI). The archive is about 2 GB; after downloading, check that its MD5 checksum matches the one shown beside the file on the Zenodo record (the README of this repository shows the command for your operating system).
